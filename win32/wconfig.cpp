...
#define ADD2(n) ADDB(n,Enabled); ADD(n,Up); ADD(n, Up_Alt); ADD(n,Down); ADD(n,Down_Alt); ADD(n,Left); ADD(n,Left_Alt); ADD(n,Right); ADD(n,Right_Alt); ADD(n,A); ADD(n,B); ADD(n,Y); ADD(n,X); ADD(n,L); ADD(n,R); ADD(n,Start); ADD(n,Select); ADDN(n,Left_Up,Left+Up); ADDN(n,Right_Up,Right+Up); ADDN(n,Right_Down,Right+Down); ADDN(n,Left_Down,Left+Down)
